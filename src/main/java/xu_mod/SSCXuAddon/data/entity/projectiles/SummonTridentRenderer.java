...
public class SummonTridentRenderer extends EntityRenderer<SummonTrident> {
    public static final Identifier TEXTURE = SSCXuAddon.identifier("textures/entity/summon_trident.png");

    private final SummonTridentModel model;

    protected SummonTridentRenderer(EntityRendererFactory.Context ctx) {
        super(ctx);
